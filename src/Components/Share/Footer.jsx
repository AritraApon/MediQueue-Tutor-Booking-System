...
const Footer = () => {
    ...
    // Reusable Icon Wrapper to keep it clean
    const SocialIcon = ({ d, href }) => (
        <a href={href} className="p-2 rounded-full bg-gray-50 dark:bg-zinc-900 text-gray-400 hover:text-blue-600 transition-colors">
    ...
    return (
        <footer className="bg-blue-50 dark:bg-zinc-950 border-t border-gray-100 dark:border-zinc-800 pb-8 pt-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><Link href="/my-booking-sessions" className="text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Lesson Bookings</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3 text-gray-500">
                                <svg className="w-5 h-5 mt-1 text-blue-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
