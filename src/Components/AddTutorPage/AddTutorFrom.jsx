...
const AddTutorFrom = () => {
 ...
 console.log(user)
  const addTutor = async (e) => {
    ...
    const addTutorData = Object.fromEntries(fromData.entries());
    addTutorData.userEmail =user?.email;
        ...
        <div>
            <section className="min-h-screen py-12 px-4 bg-[#F0F7FF] dark:bg-[#0A0F1C] transition-colors duration-300">
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        <Form onSubmit={addTutor} className="w-full flex flex-col gap-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                {/* 3. SUBJECT / CATEGORY */}
                                <Select  name="subject" className="flex flex-col gap-1.5">
                                    <Label className="text-xs font-bold text-blue-900 dark:text-blue-100/80 tracking-widest uppercase px-1">Subject</Label>
                                ...
                                {/* 4. TEACHING MODE */}
                                <Select  name="teachingMode" className="flex flex-col gap-1.5">
